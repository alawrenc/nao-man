...
LANDMARK_OPP_GOAL_LEFT_POST = Location(LANDMARK_OPP_GOAL_LEFT_POST_X,
                                       LANDMARK_OPP_GOAL_LEFT_POST_Y)
LANDMARK_OPP_GOAL_RIGHT_POST = Location(LANDMARK_OPP_GOAL_RIGHT_POST_X,
                                        LANDMARK_OPP_GOAL_RIGHT_POST_Y)
LANDMARK_MY_GOAL_LEFT_POST = Location(LANDMARK_MY_GOAL_LEFT_POST_X,
                                      LANDMARK_MY_GOAL_LEFT_POST_Y)
LANDMARK_MY_GOAL_RIGHT_POST = Location(LANDMARK_MY_GOAL_RIGHT_POST_X,
...
MY_GOAL = Location(MY_GOALBOX_LEFT_X, MY_GOALBOX_MIDDLE_Y)
...
OPP_GOAL = Location(OPP_GOALBOX_LEFT_X, OPP_GOALBOX_MIDDLE_Y)
