...
class FSA(State):
    ...
    def printf(self,outputString, printingColor='green'):
        ...
        if printingColor == 'red':
            self.outputFunction(RED_COLOR_CODE + str(outputString) +
                                RESET_COLORS_CODE)
        elif printingColor == 'blue':
            self.outputFunction(BLUE_COLOR_CODE + str(outputString) +
                                RESET_COLORS_CODE)
        elif printingColor == 'yellow':
            self.outputFunction(YELLOW_COLOR_CODE + str(outputString) +
                                RESET_COLORS_CODE)
        elif printingColor == 'cyan':
            self.outputFunction(CYAN_COLOR_CODE + str(outputString) +
                                RESET_COLORS_CODE)
        elif printingColor == 'purple':
            self.outputFunction(PURPLE_COLOR_CODE + str(outputString) +
                                RESET_COLORS_CODE)
        elif printingColor == 'purplebg':
            self.outputFunction(PURPLE_BG_COLOR_CODE + str(outputString) +
                                RESET_COLORS_CODE)
        elif printingColor == 'whitebg':
            self.outputFunction(WHITE_BG_COLOR_CODE + str(outputString) +
                                RESET_COLORS_CODE)
        elif printingColor == 'greenbg':
            self.outputFunction(GREEN_BG_COLOR_CODE + str(outputString) +
                                RESET_COLORS_CODE)
        elif printingColor == 'green':
            self.outputFunction(GREEN_COLOR_CODE + str(outputString) +
                                RESET_COLORS_CODE)
        else:
